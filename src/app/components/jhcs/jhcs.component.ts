...
@Component({
  selector: 'app-jhcs',
  templateUrl: './jhcs.component.html',
  styleUrls: ['./jhcs.component.css']
})
export class JhcsComponent  implements AfterViewInit {
  ...
  constructor(
    ...
    dialogService.showWarningMessageDialog(environment.jhcsAlert.title, environment.jhcsAlert.message);
  }
  ...
  private fetch() {
    this.jhcsService
      ...
      .subscribe({
        next: (item) => {
          console.log("Jhcs", item);
          this.dataSource = new MatTableDataSource(item);
          this.dataSource.paginator = this.paginator;
          this.dataSource.sort = this.sort;
        },
        error: (err) => console.log("recenterr", err),
        complete: () => console.log("Recent Record completed")
      });
  }
